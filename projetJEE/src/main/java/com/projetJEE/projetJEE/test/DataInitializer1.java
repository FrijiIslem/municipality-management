...
public class DataInitializer1 implements CommandLineRunner {
    ...
    public void run(String... args) {
		...
		/*
		 * // ----- AGENTS ----- Agent agent1 = new Agent(); agent1.setPrenom("Ali");
		 * agent1.setNom("Ben Salah"); agent1.setDisponibilite(true);
		 * agent1.setPlageHoraire("8h-16h"); agent1.setTache("Collecte");
		 * agent1.setRole(Utilisateur.RoleUtilisateur.AGENT);
		 * agent1.setEmail("ali.bensalah@email.com"); agent1.setPassword("passAli123");
		 * utilisateurRepository.save(agent1); System.out.println("✔ Agent ajouté : " +
		 * agent1.getId());
		 * 
		 * Agent agent2 = new Agent(); agent2.setPrenom("Sara");
		 * agent2.setNom("Khlifi"); agent2.setDisponibilite(true);
		 * agent2.setPlageHoraire("10h-18h"); agent2.setTache("Nettoyage");
		 * agent2.setRole(Utilisateur.RoleUtilisateur.AGENT);
		 * agent2.setEmail("sara.khlifi@email.com"); agent2.setPassword("passSara123");
		 * utilisateurRepository.save(agent2); System.out.println("✔ Agent ajouté : " +
		 * agent2.getId());
		 * 
		 * // ----- CITOYENS ----- Citoyen citoyen1 = new Citoyen();
		 * citoyen1.setPrenom("Farah"); citoyen1.setNom("Moussa");
		 * citoyen1.setAdresse("Sfax");
		 * citoyen1.setRole(Utilisateur.RoleUtilisateur.CITOYEN);
		 * citoyen1.setEmail("farah.moussa@email.com");
		 * citoyen1.setPassword("passFarah123"); utilisateurRepository.save(citoyen1);
		 * System.out.println("✔ Citoyen ajouté : " + citoyen1.getId());
		 * 
		 * Citoyen citoyen2 = new Citoyen(); citoyen2.setPrenom("Molka");
		 * citoyen2.setNom("Moussa"); citoyen2.setAdresse("Sousse");
		 * citoyen2.setRole(Utilisateur.RoleUtilisateur.CITOYEN);
		 * citoyen2.setEmail("molka.moussa@email.com");
		 * citoyen2.setPassword("passMolka123"); utilisateurRepository.save(citoyen2);
		 * System.out.println("✔ Citoyen ajouté : " + citoyen2.getId());
		 * 
		 * Citoyen citoyen3 = new Citoyen(); citoyen3.setPrenom("Ahmed");
		 * citoyen3.setNom("Trabelsi"); citoyen3.setAdresse("Tunis");
		 * citoyen3.setRole(Utilisateur.RoleUtilisateur.CITOYEN);
		 * citoyen3.setEmail("ahmed.trabelsi@email.com");
		 * citoyen3.setPassword("passAhmed123"); utilisateurRepository.save(citoyen3);
		 * System.out.println("✔ Citoyen ajouté : " + citoyen3.getId());
		 * 
		 * // ----- INCIDENTS ----- Incident incident1 = new Incident();
		 ...
		 * incident1.setDate(new Date()); incident1.setUtilisateurId(citoyen1.getId());
		 ...
		 * incident2.setDate(new Date()); incident2.setUtilisateurId(citoyen2.getId());
		 ...
		 * incident3.setDate(new Date()); incident3.setUtilisateurId(citoyen3.getId());
